...
template <bool reverse> class mvccScanner {
 ...
 private:
  ...
  bool getFromIntentHistory() {
    kwbase::storage::enginepb::MVCCMetadata_SequencedIntent readIntent;
    readIntent.set_sequence(txn_sequence_);

    auto end = meta_.intent_history().end();
    kwbase::storage::enginepb::MVCCMetadata_SequencedIntent intent;
    ...
    auto up = std::upper_bound(
        ...
        [](const kwbase::storage::enginepb::MVCCMetadata_SequencedIntent& a,
           const kwbase::storage::enginepb::MVCCMetadata_SequencedIntent& b) -> bool {
 ...
 public:
  ...
  bool peeked_;
  kwbase::storage::enginepb::MVCCMetadata meta_;
